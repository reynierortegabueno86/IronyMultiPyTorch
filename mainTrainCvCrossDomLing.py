...
def check_params(args=None):
    ...
    parse.add_argument('-t', '--test', help='File with the input data for testing', required=True, default="training.tsv")
...
if __name__ == "__main__":
    ...
    ironyTrainID, ironyTrainLabels, ironyDataTrain = ironyDataTrain["id"], ironyDataTrain["irony"], ironyDataTrain[["irony", "preprotext"]]
    ...
    ironyTestID, ironyTestLabels, ironyDataTest = ironyDataTest["id"], ironyDataTest["irony"], ironyDataTest[["irony", "preprotext"]]
    # ironyLabels=ironyData["irony"]
    # ironyData=ironyData[["irony","preprotext"]]
